...
namespace BunBunHub.Formularios
{
    public partial class RegistrarUsuario : Form
    {
        ...
        private bool Verification(string usario, string contrasena)
        {
            listaUsuarios = ManejoArchivos<Usuarios>.CargarDatos(RegistrarUsuario.nuevarutaUsuarios);
            foreach(Usuarios us in listaUsuarios)
            {
                if(us.Usuario == usario || us.Contraseña== contrasena)
                {
                    MessageBox.Show("Usuario o Contraseña ocupado", "Error de datos",MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
            }
            return true;
        ...
        private void tlsbtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (rolSeleccionado == "Cliente")
            {
                ...
                if (Verification(nuevoCliente.Usuario, nuevoCliente.Contraseña))
                {
            ...
            else if (rolSeleccionado == "Administrador" || rolSeleccionado == "Colaborador")
            {
                ...
                if (Verification(nuevoUsuario.Usuario, nuevoUsuario.Contraseña))
                {
