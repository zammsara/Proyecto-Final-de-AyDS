...
namespace BunBunHub.Formularios
{
    public partial class RegistrarCliente : Form
    {
        ...
        private void tlsbtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            string rol = txtRol.Text; //obtener el rol seleccionado
            ...
            Usuarios nuevoUsuario = new Usuarios(usuario, contraseña, rol, estado);
        ...
        private void tlsbtnVisualizarRegistros_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(txtUsuarioNombre.Text) || !string.IsNullOrWhiteSpace(txtContraseña.Text) || !string.IsNullOrWhiteSpace(txtConfirmarContraseña.Text) ||
                !string.IsNullOrWhiteSpace(txtNombre.Text) || !string.IsNullOrWhiteSpace(txtApellido.Text) || !string.IsNullOrWhiteSpace(txtCorreo.Text) ||
                !string.IsNullOrWhiteSpace(txtTelefono.Text) || cmbEstado.SelectedIndex != -1)
            {
                hayDatos = true;
            }
            ...
            if (hayDatos)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    actualizarCliente.listaUsuarios = listaUsuarios;
                    actualizarCliente.listaClientes = listaClientes;
                    actualizarCliente.CargarDatos();
